...
exports.getSessionMe = getSessionMe;
...
function listSessions() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        return __generator(this, function (_a) {
            p = makePath('/api/sessions', args.pathParams) || '/api/sessions';
...
function getSession() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        if (args === void 0) { args = {}; }
        return __generator(this, function (_a) {
            p = makePath('/api/sessions/{session}', args.pathParams) || '/api/sessions/{session}';
            return [2 /*return*/, (0, client_js_1.getClient)().get(p, args.query)];
        });
    });
}
 ...
 */
function getSessionMe() {
    return __awaiter(this, arguments, void 0, function (args) {
        var p;
        if (args === void 0) { args = {}; }
        return __generator(this, function (_a) {
            p = makePath('/api/sessions/{session}/me', args.pathParams) || '/api/sessions/{session}/me';
            return [2 /*return*/, (0, client_js_1.getClient)().get(p, args.query)];
        });
    });
}
