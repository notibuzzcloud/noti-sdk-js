...
function getMyProfile() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        return __generator(this, function (_a) {
            p = makePath('/api/{session}/profile', args.pathParams) || '/api/{session}/profile';
...
function setProfileName() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        if (args === void 0) { args = {}; }
        return __generator(this, function (_a) {
            p = makePath('/api/{session}/profile/name', args.pathParams) || '/api/{session}/profile/name';
...
function setProfileStatus() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        if (args === void 0) { args = {}; }
        return __generator(this, function (_a) {
            p = makePath('/api/{session}/profile/status', args.pathParams) || '/api/{session}/profile/status';
            return [2 /*return*/, (0, client_js_1.getClient)().put(p, args.body)];
        });
    });
}
...
function setProfilePicture() {
    return __awaiter(this, arguments, void 0, function (args) {
        ...
        if (args === void 0) { args = {}; }
        return __generator(this, function (_a) {
            p = makePath('/api/{session}/profile/picture', args.pathParams) || '/api/{session}/profile/picture';
            return [2 /*return*/, (0, client_js_1.getClient)().put(p, args.body)];
        });
    });
}
